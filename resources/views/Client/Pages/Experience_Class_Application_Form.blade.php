...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb" style="padding-left: 50px">
            ...
            <li class="item">&nbsp;体験授業プログラム/学校説明会 > 体験授業お申し込みフォーム</li>
        </ol>
    </nav>
	<div class="container">
		<div class="row">
			<div class="col-md-12" style="margin-bottom: 20px;">
				<span style="background-color: #92c5ea; width:12px; height:41px; padding:0; margin:0; float: left;"></span><h2 class="access_title" style="padding-left:30px;">体験授業お申し込みフォーム　Experience Class Application Form 
				</h2>
			</div>
		</div>
	</div>
...
<div class="full_design_g_u_application">
	<div class="container">
		...
		<div class="row" id="application_form_s">
			<div class="col-4">
				<p class="application_f">体験授業希望日</p>
			</div>
			<div class="col-8">
				<select class="form-control" name="meeting">
					<option value="">日付を選択 ..</option>
					<option value="2019/5/26（日）グラフィックデザン体験授業">2019/5/26（日）グラフィックデザン体験授業</option>
					<option value="201 9/6/1 6（日）デッサン体験授業">201 9/6/1 6（日）デッサン体験授業</option>
					<option value="2019/6/30（日）イラスト験授業">2019/6/30（日）イラスト験授業</option>
					<option value="2019/7/28 (日) イラスト体験授業">2019/7/28 (日) イラスト体験授業</option>
					<option value="2019/8/10  (土) イラスト体験授業">2019/8/10  (土) イラスト体験授業</option>
				</select>
			</div>
		</div>
		<div class="row">
